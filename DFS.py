...
class MissionariesCannibalsGame:
    def __init__(self, root):
        ...
        self.solve_button = tk.Button(self.root, text="Solve", command=self.solve_dfs)
        self.solve_button.pack()

    def solve_dfs(self):
        print("Solving with Depth-First Search")

        solution = self.solve_missionaries_cannibals()
        self.display_solution(solution)

    def solve_missionaries_cannibals(self):
